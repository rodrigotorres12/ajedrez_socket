   ...
   for (int subLine = 0; subLine < CELL/2; subLine++)
   {
      ...
      for (int iPair = 0; iPair < 4; iPair++)
      {
         ...
         for (int subColumn = 0; subColumn < CELL; subColumn++)
         {
            ...
            {
               cout << char(game.getPieceAtPosition(iLine, iPair*2) != 0x20 ? game.getPieceAtPosition(iLine, iPair*2) : 32);
            }
            else
            {
               cout << " ";
         ...
         for (int subColumn = 0; subColumn < CELL; subColumn++)
         {
            ...
            if ( subLine == 1 && subColumn == 3)
            {
               cout << char(game.getPieceAtPosition(iLine,iPair*2+1) != 0x20 ? game.getPieceAtPosition(iLine,iPair*2+1) : 32);
            }
            else
            {
               cout << " ";
